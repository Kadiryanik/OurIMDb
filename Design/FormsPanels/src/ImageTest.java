	...
	public static void main(String[] args){
		...
		try{
			...
			for(int i = 0; i < list.size(); i++){
				BufferedImage originalImage = ImageIO.read(new File("C:\\Workplace\\OurIMDb\\DB\\c\\"+ list.get(i).getpTitle() +".jpg"));
				...
				ImageIO.write(resizeImageJpg, "jpg", new File("C://Workplace//OurIMDb//DB//d//"+ list.get(i).getpTitle() +".jpg"));
			}
